...
4. Manager location browser. Initial read-only coverage list implemented at `/:tenantSlug/manager/locations`; staging-smoked on 2026-07-04 with status/search/area filters and location drilldown links.
5. Representative drilldown. Initial read-only workload list implemented at `/:tenantSlug/manager/representatives`; staging-smoked on 2026-07-04 with search/activity filters and representative drilldown links.
6. Field visit history. Initial own-scope history view implemented at `/:tenantSlug/field/history`; staging-smoked on 2026-07-04 with status and started-date filters.
