...
| Expanded self-serve product smoke      | Newly wired Field, Admin imports and Manager actions were added after the first staging smoke | Must pass before self-serve pilot                                                                                                                                       |
...
7. Rerun expanded product smoke after the latest frontend/backend changes deploy.
