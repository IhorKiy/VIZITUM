...
6. Configure operations summary token and rerun `npm run alerts:check` with `OPERATIONS_SUMMARY_URL`.
7. Keep the audio MIME alias hardening fix in the next deploy for broader browser/file compatibility.
