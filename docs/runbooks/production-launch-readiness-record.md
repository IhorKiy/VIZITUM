...
| Smoke checks       | Login, tenant lookup, field, imports, manager dashboard, manual report confirmation pass                         | Staging recheck needed | Initial staging smoke passed for login, tenant lookup, field page, imports page, manager dashboard and manual report confirmation. Repeat smoke after newly wired self-serve actions deploy: field visit creation, browser voice recording, import validation/confirm, manager CSV export and manager task assignment. |
...
| Expanded product smoke checks need to be repeated after the latest self-serve UI changes deploy. | Medium   | Ihor Kiyanych | Repeat staging smoke for field visit creation, browser voice recording, import validation/confirm, manager CSV export and manager task assignment, then repeat the accepted smoke path against production before pilot launch. | Yes             |
...
- Rerun expanded staging product smoke after the latest self-serve UI changes deploy.
