...
| Expanded product smoke checks need to be repeated after the latest self-serve UI changes deploy. | Medium   | Ihor Kiyanych | Repeat staging smoke with `docs/runbooks/expanded-staging-product-smoke.md`, then repeat the accepted smoke path against production before pilot launch.                      | Yes             |
...
- Rerun expanded staging product smoke with `docs/runbooks/expanded-staging-product-smoke.md` after the latest self-serve UI changes deploy.
