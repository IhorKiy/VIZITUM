...
Mitigation update: unavailable assisted-pilot action controls were disabled in the frontend after this review. The Field page now includes text note capture, voice note upload fallback and a minimal manual report confirmation form for assigned visits.
