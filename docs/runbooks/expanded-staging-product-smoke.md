...
| Field AI draft state          | Review AI draft state messaging on visit cards and manual fallback guidance.                          | AI draft state panel explains ready/processing/fallback/confirmed states and manual fallback remains available.                    | New P0 messaging added after the 2026-07-02 smoke; verify after next staging deploy.                                                                                                                                  | Pending                       |
| Field location/tasks panel    | Review Field location cards and update a non-critical own task status.                                | Location cards render live tenant locations; own task panel renders assigned tasks and status update success notice appears.       | New P0 panel added after the 2026-07-02 smoke; verify after next staging deploy.                                                                                                                                      | Pending                       |
...
| Admin pilot review            | Open Admin pilot review and inspect/copy the summary.                                                 | Usage metrics, threshold statuses and copyable summary render from live tenant data without demo fallback.                         | New P0 screen added after the 2026-07-02 smoke; verify after next staging deploy.                                                                                                                                     | Pending                       |
