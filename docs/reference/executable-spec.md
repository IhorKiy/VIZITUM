...
- Track B, pilot data model completeness: existing tests cover current import template types, parsers and validate-preview-confirm behavior. They do not yet define the final minimum customer onboarding dataset or sample data packs.
