...
export function TagIcon() {
  return (
    <svg
      ...
      width="16"
    >
      <path d="M3 11.5V4a1 1 0 0 1 1-1h7.5a1 1 0 0 1 .7.3l8 8a1 1 0 0 1 0 1.4l-6.5 6.5a1 1 0 0 1-1.4 0l-8-8a1 1 0 0 1-.3-.7Z" />
...
export function MicIcon({ size = 16 }: { size?: number }) {
  return (
    <svg
      ...
      width={size}
    >
      <rect height="13" rx="4" width="6" x="9" y="2" />
...
export function ListTodoIcon({ size = 16 }: { size?: number }) {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
export function HelpCircleIcon({ size = 16 }: { size?: number }) {
  return (
    <svg
      aria-hidden="true"
      fill="none"
